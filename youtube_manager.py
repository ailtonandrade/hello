...
class YouTubeManager:
    ...
    def automate_youtube_posting(self, theme, channel, text_narration, video_path=None):
        ...
        title = self.get_text_by_ollama(f"Generate in Brazilian Portuguese a catchy YouTube video title based on this narration: {text_narration_example}, respond only title, without any extra text.")
        description = self.get_text_by_ollama(f"Generate in Brazilian Portuguese a detailed YouTube video description based on this narration: {text_narration_example}, respond only description, without any extra text.")
        video_info = {
            "filepath": video_path,
            "generated_info": {
                            "title": title,
